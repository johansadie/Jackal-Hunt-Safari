...
*/
        ...
        $('#menu-toggle-wrapper').on('click', function(event){
            ...
            if($('#navigation').is(':visible')) {
                var main = $('section section, .home-slider, .hero, footer, .mbYTP_wrapper');
                main.removeClass('hide');
                $('body').scrollTop($(this).data('body-scroll-top'));
            } else {
                var main = $('section section, .home-slider, .hero, footer, .mbYTP_wrapper');
                main.addClass('hide');
                $(this).data('body-scroll-top', $('body').scrollTop());
            }
        ...
        $('#navigation li a').on('click', function(event){
            ...
            $('body').scrollTop( $('#menu-toggle-wrapper').data('body-scroll-top') );
